...
public interface RedisClientTemplate {
  ...
  void lazySet(String key, Object value, Integer expire);
  ...
  * */
   ...
   */
  void setStringWithTime(final String key, final String value, Integer expire);
   ...
   */
  void setMapKey(String key, String field, String value);
  ...
  void setMap(String key, Map<String, String> hash, Integer expire);
   ...
   */
  Map<Object, Object> getAllHash(final String key);
 /*=================================List=============================*/
